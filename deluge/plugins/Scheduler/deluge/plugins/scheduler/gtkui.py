...
class SchedulerSelectWidget(Gtk.DrawingArea):
    ...
    def get_point(self, event):
        size = Gtk.Window.get_allocation(self)
...
class GtkUI(GtkPluginBase):
    ...
    def create_prefs_page(self):
        ...
        grid.attach(self.spin_download, 1, 1, 1, 1)
        ...
        grid.attach(self.spin_upload, 1, 2, 1, 1)
        ...
        grid.attach(self.spin_active, 3, 1, 1, 1)
        ...
        grid.attach(self.spin_active_down, 3, 2, 1, 1)
        ...
        grid.attach(self.spin_active_up, 3, 3, 1, 1)
